...
if(isset($_POST["submit"])){
  ...
  $query1 = "INSERT INTO stud_personal VALUES('$roll','$name', '$age','$year', '$gender', '$contact', '$ctc')";
  $result1= mysqli_query($con,$query1);

  $query2 = "INSERT INTO stud_acad VALUES('$roll','$branch', '$marks_10', '$marks_12', '$cpi','$aoi')";
