...
if(isset($_GET['loginerror'])) {
 ...
 if(!empty($loginerror)){  echo '<p class="errmsg">Invalid login credentials, Please Try Again..</p>'; } ?>
    <p style="font-size: 30px;text-align: center;margin-top: 30px; color:#fff;font-weight:bold">Alumni Login</p>
...
<p style="font-size: 18px;text-align: center;margin-top: 30px;"><a href="register.php" style="color:#fff;">Register</a></p>
<br>
</div>
            </div>
        <div class="col-sm-4">
